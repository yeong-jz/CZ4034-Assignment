...
class LazadaSpider(scrapy.Spider):
    ...
    start_urls = [
                  'https://www.lazada.sg/shop-audio/?page=1',
                  ]
...
##        result = response.xpath('//script').extract()[2]
...
##            yield response.follow(str(href), self.parse_item)
        element = self.browser.find_elements_by_xpath('//*[@id="root"]/div/div[3]/div[1]/div/div[1]/div[2]/div[1]/div/div/div[1]/div[1]/a')
        for i in element:
            print(i.text)
    ...
    def parse_item(self, response):
        item = LazadaItem()
        item['name'] = self.browser.find_element_by_xpath('//*[@id="module_product_title_1"]/h1/text()').extract_first(default='null'),
        item['brand'] = self.browser.find_element_by_xpath('//*[@id="module_product_brand_1"]/div/a[1]/text()').extract_first(default='null'),
        item['generalCat'] = self.browser.flind_element_by_xpath('//*[@id="J_breadcrumb"]/li[4]/span/a/span/text()').extract_first(default='null'),
        item['salePrice'] = self.browser.find_element_by_xpath('//*[@id="module_product_price_1"]/div/span/text()').extract_first(default='null'),
        item['originalPrice'] = self.browser.find_element_by_xpath('//*[@id="module_product_price_1"]/div/div/span[1]/text()').extract_first(default='null'),
        item['rating'] = self.browser.find_element_by_xpath('//*[@id="module_product_review"]/div/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/span/text()').extract_first(default='null'),
        item['noOfRatings'] = self.browser.find_element_by_xpath('//*[@id="module_product_review_star_1"]/div/a[1]/text()').extract_first(default='null'),
        item['positiveSellerRatings'] = self.browser.find_element_by_xpath('//*[@id="module_seller_info"]/div/div[2]/div[1]/div/div/text()').extract_first(default='null'),
        item['returnPolicy'] = self.browser.find_element_by_xpath('//*[@id="module_seller_warranty"]/div/div[2]/div[1]/div/div/div/div/text()').extract_first(default='null'),
        item['warranty'] = self.browser.find_element_by_xpath('//*[@id="module_seller_warranty"]/div/div[2]/div[2]/div/div/div/div/text()').extract_first(default='null'),
        item['economyDeliveryPrice'] = self.browser.find_element_by_xpath('//*[@id="module_seller_delivery"]/div/div/div[3]/div/div[2]/div/div/div[2]/text()').extract_first(default='null'),
        item['standardDeliveryPrice'] = self.browser.find_element_by_xpath('//*[@id="module_seller_delivery"]/div/div/div[3]/div/div[3]/div/div/div[2]/text()').extract_first(default='null'),
        item['expressDeliveryPrice'] = self.browser.find_element_by_xpath('//*[@id="module_seller_delivery"]/div/div/div[3]/div/div[4]/div/div/div[2]/text()').extract_first(default='null'),
        return item
